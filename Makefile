...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon Jun 20 14:13:47 2016
# Project:  QtCalc.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile QtCalc.pro
#############################################################################
...
Makefile: QtCalc.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QtCalc1.0.0/ && $(COPY_FILE) --parents calc.cpp .tmp/QtCalc1.0.0/ && (cd `dirname .tmp/QtCalc1.0.0` && $(TAR) QtCalc1.0.0.tar QtCalc1.0.0 && $(COMPRESS) QtCalc1.0.0.tar) && $(MOVE) `dirname .tmp/QtCalc1.0.0`/QtCalc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QtCalc1.0.0
